...
public class LDAPTest {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapSearchBase = "uid=admin,ou=system";
        
        final String ldapUsername = "uid=admin,ou=system";
        final String ldapPassword = "secret";
        
        final String ldapAccountToLookup = "uid=admin,ou=system";
		...
		System.out.println("lookup the ldap account " + srLdapUser);
		...
		System.out.println("Primary Group Name " + primaryGroupName);
    }
